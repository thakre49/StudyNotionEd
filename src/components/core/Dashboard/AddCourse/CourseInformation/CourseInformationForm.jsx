...
function CourseInformationForm() {
    ...
    const onSubmit = async (data) => {
        ...
        //Create a new course
        console.log("Creating New Form...", course)
        const formData = new FormData()
        formData.append("courseName", data.courseTitle)
        formData.append("courseDescription", data.courseShortDesc)
        formData.append("price", data.coursePrice)
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)}
            ...
            <div className="flex flex-col space-y-2">
                <label htmlFor='courseTitle' className="text-sm text-richblack-5" >Course Title <sup>*</sup>
                </label>
            ...
            {/* Course Description */}
            <div className="flex flex-col space-y-2">
                <label htmlFor='courseShortDesc' className="text-sm text-richblack-5" >Course Short Description <sup>*</sup>
                </label>
            ...
            {/* Course Price */}
            <div className="flex flex-col space-y-2">
                <label htmlFor='coursePrice' className="text-sm text-richblack-5">Course Price <sup>*</sup>
                </label>
                ...
                {
                    errors.coursePrice && (
                        <span className="ml-2 text-xs tracking-wide text-pink-200">Course Price is required
                        </span>
                    )
                }
            </div>
            ...
            {/* Course Category */}
            <div className="flex flex-col space-y-2" >
                <label htmlFor='courseCategory' className="text-sm text-richblack-5">Course Category<sup>*</sup>
                </label>
            ...
            <div className="flex flex-col space-y-2">
                <label className="text-sm text-richblack-5" htmlFor="courseBenefits">Benifits of the course
                </label>
...

                {
                    errors.courseBenefits && (
                        <span className="ml-2 text-xs tracking-wide text-pink-200">Benifits of the course are required
                        </span>
                    )
                }
            </div>
